// Integration test for DirectParser configurability
use picojson::{ArrayBitStack, BitStackStruct, DirectParser, Event, Reader};
...
#[test]
fn test_direct_parser_default_config() {
...
#[test]
fn test_direct_parser_custom_bitstack_config() {
    let json = b"{\"value\": 42}";
...
#[test]
fn test_direct_parser_array_bitstack_config() {
    ...
    let mut parser =
        DirectParser::<_, ArrayBitStack<4, u32, u16>>::with_config(reader, &mut buffer);
